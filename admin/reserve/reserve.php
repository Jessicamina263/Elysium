...
<head>
    ...
    <title>ELYSIUM - Reservation Dashboard</title>
</head>
<body>
    <div style="display: flex; flex-direction: row;">
        ...
        <div class="dashboard-container">
            <div class="header">
                <h1>ELYSIUM</h1>
                <h2 class="title">Reservation Dashboard</h2>
            </div>
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                        ...
                        $sql = "SELECT id ,name, email, phone, people, date, DATE_FORMAT(time, '%h:%i %p') AS formatted_time
                        FROM reservations;";
